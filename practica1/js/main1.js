$(document).ready(function(){
	...
	$('#button-menu').click(function(){
		if($('#button-menu').attr('class') == 'fas fa-bars' ){
			...
			$('#button-menu').removeClass('fas fa-bars').addClass('fas fa-times'); // Agregamos el icono X
			...
			$('#button-menu').removeClass('fas fa-times').addClass('fas fa-bars'); // Agregamos el icono del Menu
